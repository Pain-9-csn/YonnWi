...
class CaptureAudioController
{
    ...
    public function index(): void
    {
        ...
        // Xassidas populaires (pour les suggestions rapides)
    ...
    // =========================================
    // AJAX — Identifier un xassida à partir d'un
    //        segment audio (base64 ou fingerprint)
    // =========================================
    ...
    public function identifier(): void
    {
        ...
        // Recherche du xassida correspondant dans la DB
        $resultat = $this->model->rechercherParFingerprint($fingerprint);

        if ($resultat) {
            // Sauvegarder la tentative
            $this->model->sauvegarderCapture(
                $userId,
                $resultat['id'],
                $duree,
                $fingerprint
    ...
    // =========================================
    // AJAX — Récupérer les xassidas populaires (JSON)
    // =========================================
