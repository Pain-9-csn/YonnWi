...
<div class="container" id="container">
    ...
    <div class="form-container sign-up">
        <form method="POST" action="login.php">
            ...
            <input type="email"    name="email"     placeholder="Adresse email"            required>
            <input type="password" name="password"  placeholder="Mot de passe (≥ 6 car.)" required>
    ...
    <div class="overlay">
        <div class="overlay-content">
            ...
            <button class="switch-btn" id="switchBtn" type="button">S'inscrire</button>
        </div>
    </div>
</div>
...
<script>
    ...
    <?php if ($success): ?>
    // Si inscription réussie → basculer sur le formulaire de connexion
    ...
    <?php if ($error && isset($_POST['register'])): ?>
    // Garder le formulaire d'inscription visible si erreur
